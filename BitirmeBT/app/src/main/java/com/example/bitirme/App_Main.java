        ...
        try {
            if (!connection.isConnectionEstablished()){
                if(connection.startConnection())
                    Toast.makeText(this, "Connection is established!!", Toast.LENGTH_SHORT).show();
            }
        }catch (Exception e){
            e.printStackTrace();
            Toast.makeText(this, "Connection is not found. BT options will be disabled. Check your device status",
