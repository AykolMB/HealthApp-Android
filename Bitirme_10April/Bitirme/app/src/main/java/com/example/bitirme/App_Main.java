    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        measureTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //long result = connection.sendRequest(109); // 109 == m
                String resultString = connection.sendRequestString(109);

                //result = 24 101160 65 95;

                // 24 101160 65
                // 95 36(body) 40(hum)
                //String sent =  String(outsideTemp) + String(airPressure) + String(heartRate); //10
                //String sent2 = String(Spo2) + "36" + "40";
